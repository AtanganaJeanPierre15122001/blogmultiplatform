...
import com.example.blogmultiplatform.util.fetchRamdomJoke
...
@Composable
fun HomeScreen(){
    var randomJoke: RamdomJoke? by remember { mutableStateOf(null) }

    LaunchedEffect(Unit){
        fetchRamdomJoke { randomJoke = it }
    }
...
@Composable
fun HomeContent(randomJoke: RamdomJoke?) {
    val breakpoint = rememberBreakpoint()
